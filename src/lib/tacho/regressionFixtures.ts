...
export const TACHO_REGRESSION_FIXTURES: TachoRegressionFixture[] = [
  ...
  {
    id: 'read-only-helper-capture',
    description: 'Read-only desktop helper captures should be visible but not retryable parser failures.',
    importRecord: buildImportRecord({
      id: 'fixture-helper-capture-1',
      status: 'partial',
      progressPercent: 100,
      summary: 'Read-only helper EF capture stored for parser development.',
    ...
    expectedIssueKind: 'helper_capture',
    expectedRetryable: false,
  },
  {
    id: 'failed-parse',
