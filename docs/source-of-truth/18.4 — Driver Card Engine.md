...
- `18.6_Timeline_Engine.md` — consumes the normalised activities.
- `18.7_Compliance_Engine.md` — applies rules to the resulting timeline.
- `18.8_Evidence_Engine.md` — preserves the raw card files as primary evidence.
- `21_Data_Model_Specification.md` — defines `driver_card_imports` and `parser_outputs`.
