...
- `18.6_Timeline_Engine.md` — provides the unified chronological history.
- `18.8_Evidence_Engine.md` — stores evidence packs linked to compliance outcomes.
- `18.9_Evidence_Reporting_Engine.md` — transforms outcomes into professional reports.
- `21_Data_Model_Specification.md` — defines `compliance_outcomes`, `rule_versions`, and `compliance_checks`.
